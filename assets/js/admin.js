(function () {
  ...
  function renderContentFields() {
    ...
    const sectionHint =
      section.id === "nav"
        ? "Endre menynavn og huk av hvilke faste sider som skal vises. Egne knapper (f.eks. klubbshop) legges til i boksen under. Tom menytekst skjuler lenken."
        : section.id === "sections"
      ...
      if (res.ok) {
        ...
        if (!window.CCFCContent.getByPath(contentState, "members")) {
          window.CCFCContent.setByPath(
            ...
            defaults?.members || {
              title: "Bli medlem",
              lead: "Bli en del av Coventry City Scandinavia. Fyll inn skjemaet — vi godkjenner innmeldingen manuelt.",
              tag: "Medlemskap",
